...
public class ImageService {
	...
	public void getImage(Model model){
		File logofileImg = new File("/var/apps/cat/images/cat_logo.png");
		File iconfileImg = new File("/var/apps/cat/images/cat_icon.png");
		File popfileImg = new File("/var/apps/cat/images/people.png");
		try {
